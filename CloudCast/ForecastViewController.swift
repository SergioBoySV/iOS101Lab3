...
//  CloudCast
//
//  Created by Sergio Villarreal on 3/5/24.
//
...
//        let fakeData = WeatherForecast(windSpeed: 33.3, weatherCode: .partlyCloudy, precipitation: 50.6, temperature: 45.7, date: Date())
